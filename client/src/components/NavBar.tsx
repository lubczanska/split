...
const NavBar = ({ loggedInUser }: NavBarProps) => {
  ...
  return (
    <header className="navbar bg-base-100 rounded-xl py-3 px-6">
      ...
      <div className="navbar-end gap-4 invisible sm:visible">
      ...
      {/* mobile menu */}
      <div className="navbar-end visible sm:invisible dropdown dropdown-end">
        ...
        >
          <li className="w-full">
            <Link to={configData.DASHBOARD_URL} className="btn btn-outline btn-primary w-full ">
                Dashboard
            </Link>
          </li>
          <li className="w-full">
